...
import { Shield, Users, Database, Activity, Trash2, RefreshCw, XCircle, FileText, Briefcase } from 'lucide-react';
...
export default function Admin() {
    ...
    useEffect(() => {
        if (user && user.email === 'aditya.poddar3698@gmail.com') {
            fetchData();
        }
    }, [activeTab, user]);
        ...
        <div className="relative min-h-[calc(100vh-4rem)]">
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {/* Content Area */}
                        <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden min-h-[500px]">
                            {isLoading ? (
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-left">
                                                ...
                                                <tbody className="divide-y divide-gray-100 dark:divide-gray-800/50">
                                                    {users.map(u => (
                                                        <tr key={u.id} className="text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                    ...
                                    {activeTab === 'resumes' && (
                                        <div className="overflow-x-auto">
                                            <table className="w-full text-left">
                                                ...
                                                <tbody className="divide-y divide-gray-100 dark:divide-gray-800/50">
                                                    {globalResumes.map(r => (
                                                        <tr key={r.id} className="text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                            ...
                                            <table className="w-full text-left">
                                                <thead>
                                                    <tr className="text-gray-500 border-b border-gray-200 dark:border-gray-800">
                                                        ...
                                                        <th className="pb-4 font-medium">Date</th>
                                                        <th className="pb-4 font-medium text-right">Job ID</th>
                                                    </tr>
                                                </thead>
                                                <tbody className="divide-y divide-gray-100 dark:divide-gray-800/50">
                                                    {globalJobs.map(j => (
                                                        <tr key={j.id} className="text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                                            ...
                                                            <td className="py-4 font-mono text-xs text-gray-500 text-right">{j.id}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div>
                                                        ...
                                                        <select 
                                                            ...
                                                            className="w-full bg-white dark:bg-[#0f0f0f] border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500"
                                                        >
                                            ...
                                            <table className="w-full text-left">
                                                ...
                                                <tbody className="divide-y divide-gray-100 dark:divide-gray-800/50">
                                                    {logs.length === 0 ? (
                                                        ...
                                                        <tr key={log.id} className="text-gray-800 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
